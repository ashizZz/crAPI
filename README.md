...
You can use prebuilt images generated by our CI workflow by downloading the docker compose and **.env** files.
 ...
 - To use the latest stable version.
      ...
      ```
      curl -o -L /tmp/crapi.zip https://github.com/OWASP/crAPI/archive/refs/heads/main.zip
  ...
  - To use the latest development version
      ...
      ```
      curl -o -L /tmp/crapi.zip https://github.com/OWASP/crAPI/archive/refs/heads/develop.zip
